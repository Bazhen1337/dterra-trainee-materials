<div class="inner">
    <section class="section">
        <div class="features-simple features-simple--laptop-1items">
            <div class="features-simple__item">
                <div class="features-simple__icon"><img src="<?=SITE_TEMPLATE_PATH?>/img/svgs/icon_time.svg" alt=""/></div>
                <div class="ui-p1 features-simple__ui-p1">Круглосуточный доступ к средствам на счете
                </div>
            </div>
            <div class="features-simple__item">
                <div class="features-simple__icon"><img src="<?=SITE_TEMPLATE_PATH?>/img/svgs/icon_two_people.svg" alt=""/></div>
                <div class="ui-p1 features-simple__ui-p1">Контроль целевого расходования средств сотрудниками
                </div>
            </div>
            <div class="features-simple__item">
                <div class="features-simple__icon"><img src="<?=SITE_TEMPLATE_PATH?>/img/svgs/icon_cash.svg" alt=""/></div>
                <div class="ui-p1 features-simple__ui-p1">Прикрепление нескольких корпоративных карт к 1 счету
                </div>
            </div>
        </div>
    </section>
    <section class="section">
        <div class="how-connect">
            <h2 class="ui-h2 how-connect__ui-h2">Как получить карту
            </h2>
            <div class="how-connect__wrapper">
                <div class="how-connect__item">
                    ...
                    <div class="how-connect__text">
                        <div class="ui-p2 how-connect__ui-p2">Оставьте заявку <br>на сайте
                        </div>
                    </div>
                </div>
                <div class="how-connect__item">
                    ...
                    <div class="how-connect__text">
                        <div class="ui-p2 how-connect__ui-p2">Менеджер банка свяжется <br>с&nbsp;Вами в течение 1&nbsp;рабочего дня и&nbsp;договорится о встрече
                        </div>
                    </div>
                </div>
                <div class="how-connect__item">
                    ...
                    <div class="how-connect__text">
                        <div class="ui-p2 how-connect__ui-p2">Подпишите договор <br>и&nbsp;получите карту
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="section">
        <div class="application application--corporate-cards">
            <div class="application-inner">
                <form class="application-form js-form-success-popup" action="#">
                    <h2 class="ui-h2 application-form__ui-h2">Оформите online-заявку
                    </h2>
